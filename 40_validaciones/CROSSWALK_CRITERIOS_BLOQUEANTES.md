...
| 8 | Pruebas "no ejecutadas" o con errores en procesos críticos (captación/OneClick/transacciones) | Crítica | ◔→✅ **VISTA ejecutado (01-sep): ciclo vivo agosto 94.56%/94.82%** (AUD-004 cerrado). Quedan: SPM (logs, confirmatorio) e ISR-vivo (base punto-en-tiempo, SOL-003) — **insumo externo**, no falla del motor; y CAT-01 (SOL-015 días). |
