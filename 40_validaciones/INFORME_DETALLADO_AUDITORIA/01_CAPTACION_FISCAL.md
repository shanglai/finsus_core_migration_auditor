...
- **Santo y seña:** `aurumcore.yield_dto` (`iv_payment_plan_id IS NULL` = vista, `process_date='2026-08-01'`,
  ...
  `tolerancias.py`.
- **Conciliación (C vs B, base 360·dt 31):** **94.76% a 1e-8 · 95.03% al centavo.** Residuo ~5% = `dt` intra-mes
  (cuentas con devengo parcial), no defecto. `RESULTADO_vista_vivo_2026-08-28.md`.
