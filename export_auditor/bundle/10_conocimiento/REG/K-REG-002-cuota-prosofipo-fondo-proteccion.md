...
| 4 | 2026-08-19 | **Re-verify hecho:** búsqueda amplia en `system_configuration` (cobertura/protección/UDIS/25000/prosofipo/ipab/fondo/seguro/841/213) → **0 resultados** de seguro de depósitos. Ni la cuota ni una variable de cobertura obvia están ahí. Si AurumCore sostiene que la cobertura vive en System Config, **pedir el nombre exacto de la variable**. Gap C (cuota) reforzado. | Extracción BD 2026-08-19 |
